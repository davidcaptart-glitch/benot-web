        ...
        <>
          ...
          <div className="border-t-2 border-gray-100 pt-8 mb-4">
            <p className="font-bebas tracking-widest text-xs text-gray-400 mb-3 leading-relaxed">
              ¿PREFIERES PEDIR CON AYUDA PERSONALIZADA? NUESTROS BOTS TE GUÍAN PASO A PASO.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 mb-6">
              <a
                ...
                className="inline-flex items-center gap-3 font-bebas tracking-widest text-sm px-8 py-4 flex-1 justify-center bg-[#2AABEE] text-white hover:bg-[#1a8bc7] transition-all duration-200"
              >
              ...
              <a
                href="https://wa.me/34604868048?text=Hola"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 font-bebas tracking-widest text-sm px-8 py-4 flex-1 justify-center bg-[#25D366] text-white hover:bg-[#1da851] transition-all duration-200"
              >
                <svg className="w-5 h-5 fill-white flex-shrink-0" viewBox="0 0 24 24">
